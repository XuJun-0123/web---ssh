...
<s:form action="employee_login" method="post" namespace="/" theme="simple" >
	...
	<h3><s:actionerror/></h3>
		<ul class="login">
			<li class="mb_10">用户名：<s:textfield value="" name="username" class="login_input user_icon" style="width:200px"/> </li>
			<li class="mb_10">密码：<s:password value="" name="password" class="login_input user_icon" style="width:200px"/></li>
